...
public class FilterResponse {
    ...
    public final String TransferenceFilter = "TransferenceFilter";  //"sourceAccount", "destinationAccount",
    public final String[] TransferenceFilterMapping= new String[]{"id", "amount"};
